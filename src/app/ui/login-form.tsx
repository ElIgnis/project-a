...
import { emailLogin } from '@/app/lib/user-client-actions'
  ...
  return (
    <div>
      ...
      <form onSubmit={handleLogin} className="flex grow">
        <div className="flex-1 rounded-lg bg-gray-50 pt-8 pb-8">
          <div className="justify-items-center">
            ...
            <div className="w-3/6 min-w-96 max-w-2/12 pb-8 border-gray-800 border-b-2">
              ...
              <div className="justify-items-center">
                <Button className="mt-4 w-min gap-4" type="submit">
            ...
            {/* SSO */}
            {/* <div className="justify-items-center">
                <Button className="mt-4 w-min gap-4 bg-neutral-50 border-2 border-gray-800 p-8" type="submit">
